...
## Step 2: Assign Frontend Domain

Once DNS is set up, return to the app builder and enter your **frontend subdomain** (for example: `dev.mydomain.com` or `app.mydomain.com`).
...
⚠️ Note: The `auth` subdomain is reserved for authentication and cannot be used as your frontend domain.
